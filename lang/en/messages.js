export default {
  ...
  removeMemberToGroupTitle: 'Remove member {full_name} from {name}',
  removeMemberToGroupMessage: 'Member {full_name} won\'t receive emails from the group and might loos access to some resources.',
  ...
  deleteUserMessage: 'You are about to delete the user <b>{first_name} {last_name}</b>.<br> Are you sure you want to continue?',
